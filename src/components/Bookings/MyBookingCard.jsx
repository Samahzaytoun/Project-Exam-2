...
export default function MyBookingCard({ booking }) {
  ...
  const { mutate } = useMutation(['bookings', booking?.id], () => bookingRequests.deleteBooking(booking?.id), {
    enabled: false,
    onSuccess: () => {
    ...
    <Fragment>
      <div className='relative'>
        <div
          ...
          className='flex h-full flex-col lg:flex-row rounded-md group bg-neutral-900 overflow-hidden'>
